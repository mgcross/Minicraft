...
public class InstructionsMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		Font.draw("X to open inventory", screen, 0 * 8 + 4, 6 * 8, Color.get(0, 333, 333, 333));
		Font.draw("and use items,", screen, 0 * 8 + 4, 7 * 8, Color.get(0, 333, 333, 333));
		Font.draw("F to fly.", screen, 0 * 8 + 4, 8 * 8, Color.get(0, 333, 333, 333));
